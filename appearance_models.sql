-- Create appearance_models table
CREATE TABLE IF NOT EXISTS `appearance_models` (
...
-- Insert freemode models first (protected - always available)
INSERT INTO `appearance_models` (`model_name`) VALUES
('mp_m_freemode_01'),
('mp_f_freemode_01')
